    ...
    public partial class FrmPersonel : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception)
            {
                ...
                MessageBox.Show("Güncelleme işlemi gerçekleştirilemedi. Lütfen tekrara deneyin!");
            }
        ...
        private void tbxPerAra_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                btnPerAra_Click(this, new EventArgs());
            }
        }
    }
}
